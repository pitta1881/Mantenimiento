...
<table>
    ...
    <tr>
        ...
        <td>PROXIMAMENTE</td>
        <td>{{ pedido.estado }}</td>
        <td><a href='/fichaPedido?id={{ pedido.id }}'>Ir a Pedido</a></td>
    </tr>
    {% else %}
    <h2 class='error'>No hay Pedidos</h2>
    {% endfor %}
</table>
{% endblock %}", "verTodosPedidos.html", "C:\\Users\\cacu\\Desktop\\unlu\\seminario profesional\\sistema\\version2\\Mantenimiento-master\\app\\views\\verTodosPedidos.html");
    }
}
