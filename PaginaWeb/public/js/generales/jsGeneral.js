...
async function loadScriptOrdenarPagTablas(tablaID, columnas, columNoOrdenar, titulo, bButtons, printDLName) {
    return await import('/public/js/generales/ordypagtablas.js').then((Module) => {
